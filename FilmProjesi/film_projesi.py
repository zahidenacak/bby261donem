...
# --- KLASÖR KONTROLÜ ---
# Resimlerin duracağı klasör
AFIS_KLASORU = "afisler"

if not os.path.exists(AFIS_KLASORU):
    os.makedirs(AFIS_KLASORU) # Klasör yoksa oluşturur

# --- YEDEK VERİTABANI (Yerel Dosya İsimleriyle) ---
DEFAULT_DATA = {
...
class CinemaArchiveApp:
    ...
    def display_suggestion(self, title):
        ...
        if movie_data:
            ...
            # YENİ RESİM YÜKLEME MANTIĞI (Yerel Dosyadan)
